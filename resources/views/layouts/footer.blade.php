                ...
                <div class="wrap_footer">
                        ...
                        <div class="bodycontent">
                            <div id="bottom_menu" class="bottom_menu">
                                <ul id="menu-menu-bottom" class="menu">
                                    <li id="menu-item-172" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-172"><a href="https://gas.id/terms">Terms and Conditions</a></li>
                                    <li id="menu-item-168" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-168"><a href="https://gas.id/privacy">Privacy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="open_pop">
                                    ...
                                    <div class="form_feedback">
                                        ...
                                        <div class="list_form_group">
                                            ...
                                            <div class="form__group">
                                                <textarea name="opinionfeedback" class="textarea fullwidth" id="opinionfeedback" rows="10"></textarea>
                                            </div>
                    ...
                    <div class="boxbottom posleft follow">
                        ...
                        <div class="bodycontent sosmedimg_footer">
                            <ul>
                                <li class="pointer"><a href="https://www.facebook.com/aplikasigas" target="_blank"><img src="https://gas.id/assets/icon_fcb.png" /></a></li>
                                <li class="pointer"><a href="https://www.instagram.com/aplikasigas/?hl=id" target="_blank"><img src="https://gas.id/assets/icon_ing.png" /></a></li>
                                <li class="pointer"><a href="https://www.youtube.com/channel/UClCgi_15elL5D8mAdSaMFig?view_as=subscriber" target="_blank"><img src="https://gas.id/assets/youtube-symbol.png" /></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="boxbottom posleft">
                        ...
                        <div class="bodycontent appsimg_footer">
                            <ul>
                                <li class="pointer"><a href="https://play.google.com/store/apps/details?id=id.gas.app&amp;amp;hl=en" target="_blank"><img src="https://gas.id/assets/play_store.png" /></a></li>
                                <li class="pointer"><img src="https://gas.id/assets/app_store.png" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
